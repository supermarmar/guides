...
One common format for semi-structured data is JavaScript Object [[03_notation|Notation]] (JSON). The example below shows a pair of JSON documents that represent customer information. Each customer document includes address and contact information, but the specific fields vary between customers.
...
### JavaScript Object [[03_notation|Notation]] (JSON)
