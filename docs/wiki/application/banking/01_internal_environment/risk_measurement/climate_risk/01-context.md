---
tags:
  - application/banking/internal-environment/risk-measurement/climate-risk/climate-risk
  - difficulty/unknown
...
Climate risk is a rapidly maturing field. As understanding develops, it may eventually warrant inclusion across multiple risk-type chapters. For now, this file provides a self-contained overview of climate risk definitions, reporting frameworks, [[04-risk_measurement|risk measurement]] by risk type, and modelling considerations.
...
Achieving the 1.5°C target requires significant reduction in greenhouse gas emissions by governments, private institutions, and individuals. Without policy change, current trajectories point to warming well over 3°C by end of century.

### Key institutions

- **NGFS (Network for Greening the Financial System)**: 116 members (as at June 2022) comprising [[05-central_banks|central banks]] and banking regulators. Publishes carbon emission pathways and climate scenario databases. Advocates for climate risk integration into financial supervision.
- **IPCC (Intergovernmental Panel on Climate Change)**: The United Nations' body for assessing science related to climate change risks. Publishes **Representative Carbon Pathways (RCPs)**, which provide benchmarks for understanding the interrelationship between global warming and total emissions.

### Greenhouse gases

According to the IPCC, the major contributions to greenhouse gases and global warming are:
...
Global and regional trends differ:

- The **northern hemisphere** has warmed the most to date; **land has warmed more than ocean**
- The temperature that humans experience directly on land has increased by more than 1.5°C
...
- Some parts of the **Western Cape** are due to see as much as a **15% decline** in average rainfall
...
TCFD provides **recommendations** (not mandatory rules) on climate risk reporting, though some [[05-central_banks|central banks]] and regulators (e.g. the [[bank_of_england|Bank of England]]) do require firms to follow these recommendations.

The TCFD recommends that firms disclose information on the following four areas:

| Area | Description |
|---|---|
| **Metrics and targets** | Quantitative measures of climate exposure and stated reduction targets |
| **[[01-risk_management|Risk management]]** | How climate risks are identified, assessed, and managed |
...
| Scope | Definition |
|---|---|
| **Scope 1** | Emissions generated directly by processes and assets owned or controlled by the firm |
| **Scope 2** | Emissions emitted through the generation of purchased electricity |
| **Scope 3** | Emissions arising from the indirect activities of a firm — split into **upstream** (firms higher in the supply chain) and **downstream** (firms lower in the supply chain, i.e. the firm's clients) |

**Banks' emissions are primarily Scope 3 downstream** — i.e., emissions arising from the activities financed by banks, also called **funded emissions**. Funded emissions refer to the emissions arising from activities that were made possible by funding provided by a bank. A bank therefore needs to understand not only its own direct emissions but also how its lending and investment activities impact emissions in the wider economy.
...
## Climate [[04-risk_measurement|Risk Measurement]] by Risk Type

The bulk of climate risk experienced by banks is through their clients. A useful way to measure climate risk is therefore to channel it through **known risk types**, providing a familiar starting point for [[01-risk_management|risk management]] while enabling use of existing [[01-risk_management|risk management]] skills. Climate change operates at both micro and macro levels, and can affect firms not directly exposed through **supply chain effects**.
...
- **Asset repricing**: As assets begin to price in climate risk more adequately, there may be **abrupt swings** in asset prices (from no climate risk premium to a material one).
- **Historical relationship breakdown**: The reliance of firms on historical relationships in [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] models is at risk, due to changing investor sentiment and climate-driven market dynamics.
- A popular method for incorporating climate risk into [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] is a **[[03-var_limitations|Value at Risk]] (VaR) approach** that accounts for climate risk factors.

There is no consensus on the best way to incorporate climate risk into market [[04-risk_measurement|risk measurement]].

### Operational Risk

Climate change creates several operational risk exposures for banks:

- **Physical hazards**: Banks have offices, branches, ATMs, and other facilities that can be impacted by changes in rates of climate hazards (flooding, fire). Drought can also have operational impact through increased costs for managing limited water access for employees.
- **Business interruption**: Increased rate of climate hazards can impact employees and prevent access to office locations, potentially affecting a material portion of operations.
- **Reputational risk**: Goldman Sachs' 2019 TCFD report highlighted that reputational risk should receive significant focus in the climate risk context — if banks are seen as promoting climate change, this can materially impact their market share.
...
- **Retail funding**: Climate change is expected to increase the costs that individuals face within the economy, which may decrease their capacity to save — breaking down historical stability of savings products and utilisation rates of revolving credit products.
- **Wholesale funding**:
  - Investor sentiment can change as climate risk becomes more understood
...
- **[[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/application_scoring/01_introduction/01-context|Underwriting]] risk**: The increasing impact of climate change introduces material [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/application_scoring/01_introduction/01-context|underwriting]] risk in a similar way to how climate change impacts credit risk — driven primarily by physical risk events that historically would not have been seen at current frequency or severity.
