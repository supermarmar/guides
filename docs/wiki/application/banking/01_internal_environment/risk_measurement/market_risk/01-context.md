---
tags:
  - application/banking/internal-environment/risk-measurement/market-risk/market-risk-capital
  - difficulty/unknown
  - study-status/new
aliases:
---
...
To comply with the minimum capital requirements for [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] set by the [[bis|BCBS]], a bank may choose between two methodologies: the **standardised approach** and the **internal models approach (IMA)**. The methodology chosen must be approved by national authorities (in South Africa, the [[sarb|SARB]]).
...
- **Revised SA** — provides a method for banks with business models not requiring sophisticated [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] measures.
...
The use of internal models to determine [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] capital is conditional on explicit supervisory approval. This approval requires at minimum:
...
Expected shortfall plays a key role in setting [[wiki/application/banking/01_internal_environment/risk_measurement/market_risk/02-models|market risk]] capital under the IMA.