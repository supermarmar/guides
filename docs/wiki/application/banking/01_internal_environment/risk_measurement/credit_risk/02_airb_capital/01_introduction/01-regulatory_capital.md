...
Note that the original [[basel_1|Basel I]] Accord only considered credit risk in the RWA. However, an amendment in 1996 then included an RWA associated with [[05-market_risk|market risk]] as well. Some jurisdictions in emerging markets still apply the [[basel_1|Basel I]] framework. For bank groups, some of their exposure may therefore be subject to [[basel_1|Basel I]] in a specific country, [[basel_2|Basel II]] in another country and [[basel_framework|Basel III]] on consolidation.

### [[basel_2|Basel II]]

Under [[basel_2|Basel II]], Pillar 1, the minimum capital requirement for credit risk in the banking book, is calculated in a new way that reflects the credit ratings of counterparties. The capital requirement for [[05-market_risk|market risk]] remained unchanged from the 1996 Amendment, but there was a new capital charge for operational risk. The general requirement in [[basel_1|Basel I]], that banks hold a total capital equal to 8% of RWAs, remained unchanged. In response, [[basel_2|Basel II]] had a much more granular approach to risk weighting. Under [[basel_2|Basel II]], the credit [[01-risk_management|risk management]] techniques can be classified under:
...
Under the internal ratings-based (IRB) approach, regulators base the capital requirement on the [[07-var_limitations|value at risk]] calculated using a 1-year time horizon and a 99,9% confidence level. They recognise that expected losses are usually covered by the manner in which a financial institution prices its products (for example, the interest charged by a bank on a loan is designed to recover expected loan losses). The [[07-var_limitations|value at risk]] is calculated using a Gaussian copula model (single factor Vašíček) of time to default.
...
The capital given by the above equations is intended to be enough to cover unexpected losses over a 1-year period that we are 99,9% certain will not be exceeded. The WCDR is the probability of default that (theoretically) happens once every thousand bank years. The capital required is therefore the [[07-var_limitations|value at risk]] minus the expected loss.
...
For the application of [[tlac|TLAC]] and [[mrel|MREL]] requirements in the context of bank [[04-capital_management|capital management]], see [Capital — TLAC](..\..\..\..\04-capital.md). For the full [[fsb|FSB]] regulatory term sheet, see [TLAC Principles and Term Sheet](..\..\..\..\..\..\regulation\international\fsb\tlac.md).
