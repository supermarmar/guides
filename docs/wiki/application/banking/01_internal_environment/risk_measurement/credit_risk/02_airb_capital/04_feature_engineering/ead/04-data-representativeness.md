...
* **Population Stability Index (PSI)** and **Chi-Square tests** were used to compare the development ([[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/02_airb_capital/05_modelling/pd/03-risk-differentiation|risk differentiation]]) and calibration ([[07-risk_quantification|risk quantification]]) samples against the **application portfolio**.
...
* Analysis covered:
  ...
  * **Key risk drivers within each PiT segment** used for [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/02_airb_capital/05_modelling/pd/03-risk-differentiation|risk differentiation]],
