---
tags:
  - application/banking/internal-environment/risk-measurement/credit-risk/airb-capital/data-engineering/data-governance
  - difficulty/unknown
  - study-status/new
aliases:
---
...
Data governance for the CCD is overseen by the Risk, Finance and/or Treasury (RFT) team, who maintain ownership of the end-to-end data lineage and ensure adherence to the firm’s data management policy.

- **Data Source Ownership**: The RFT team is responsible for maintaining up-to-date documentation of all source systems feeding into the MDS, including data dictionaries, transformation logic, and ownership contacts.
