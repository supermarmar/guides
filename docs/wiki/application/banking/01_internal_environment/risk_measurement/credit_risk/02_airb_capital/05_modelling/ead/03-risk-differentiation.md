...
* The [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/02_airb_capital/04_feature_engineering/pd/01-target_variable|target variable]] is the **Exposure at Default Factor (EADF)**.
