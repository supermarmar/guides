---
tags:
  - application/banking/internal-environment/risk-measurement/credit-risk/airb-capital/feature-engineering/pd/data-requirements
  - difficulty/unknown
  - study-status/new
aliases:
---
...
Probability of default is estimated from a range of sources. The simplest and most widely used source throughout the world is rating agency ratings – primarily when using the SA under [[bis|Basel]]. Banks also use their own historical default databases or purchase those compiled by third parties – under the IRBA.
