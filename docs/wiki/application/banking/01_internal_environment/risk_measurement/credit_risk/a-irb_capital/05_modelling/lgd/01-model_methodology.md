...
The overall model methodology decomposes LGD into probability and severity components. [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/a-irb_capital/05_modelling/pd/03-risk-differentiation|Risk differentiation]] is achieved via a segmented set of logistic regression and generalised linear model (CLM) components. Internally this step is referred to as [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/a-irb_capital/05_modelling/pd/03-risk-differentiation|risk differentiation]], and the outputs referred the as Point in Time (PiT) LGDs.
