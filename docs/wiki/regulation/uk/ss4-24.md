...
First published on 12 September 2024, this is the most recent significant regulatory issuance from the [[pra|PRA]] ([[pra|Prudential Regulation Authority]]) affecting banks. It is guidance / supervisory statement (i.e. non-legally binding “soft” regulation) rather than a rule.

While SS4/24 is the most recent standalone issuance, it is part of a broader regime change the [[pra|PRA]] is implementing — namely, the restatement and adaptation of [[crr|CRR]] ([[crr|Capital Requirements Regulation]]) into the [[pra|PRA]]’s domestic rulebook, especially post-Brexit. This is sometimes informally referred to as the “[[crr_near_final_requirements|CRR Near Final Requirements]]” exercise. In practice, SS4/24 should be seen as a component within the [[crr|CRR]] restatement process.

This supervisory statement (SS) sets out the [[pra|PRA]]’s expectations in respect of the application of the IRB approach in the calculation of credit risk risk-weighted assets and provides explanation, where appropriate, of the [[pra|PRA]]’s expectations when assessing whether firms meet those requirements, including in respect of the conservatism applied.

This SS is relevant to [[pra|PRA]]-authorised banks, building societies, [[pra|PRA]]-designated investment firms, and [[pra|PRA]]-approved or [[pra|PRA]]-designated financial or mixed financial holding companies (collectively ‘firms’).
...
- Chapter 8: [[04-data-representativeness|data representativeness]]
...
- (b) under Group B:
  - (i) changes to [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/application_scoring/01_introduction/01-context|underwriting]] standards, collection or recovery policies, [[02-risk_appetite|risk appetite]], or other relevant internal processes;
  - (ii) unjustified deviations in the ranges of values of the key risk characteristics of the application portfolio compared with those of the data set used for [[07-risk_quantification|risk quantification]];
...
- Category B: the MoC related to relevant changes to [[wiki/application/banking/01_internal_environment/risk_measurement/credit_risk/application_scoring/01_introduction/01-context|underwriting]] standards, [[02-risk_appetite|risk appetite]], collection and recovery policies, and any other source of additional uncertainty identified under Group B as referred to in paragraph 9.1(b); and
...
9.15 The [[pra|PRA]] expects firms to regularly monitor the levels of MoCs. The [[pra|PRA]] considers that the adoption of a MoC by a firm does not replace the need to address the causes of errors or uncertainties, or to correct the models to ensure material compliance with the requirements of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part.
...
([[crr|CRR]]) Part. Firms are also required to estimate EAD for certain exposures according to
Article 166D(4) of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part.

17.2 The [[pra|PRA]] considers that there are a number of potentially compliant approaches to
estimate EAD and that an acceptable approach is to estimate EAD as a percentage of total
limit (Limit Factor estimation).

17.3 The [[pra|PRA]] considers that firms estimating Limit Factors may either:
...
and 182(1)(b) of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part; or
...
17.8 The [[pra|PRA]] expects firms using own estimates of EAD or CF to do all of the following in
...
Article 179(1)(a) of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part,
estimates must be derived using both historical experience and empirical evidence,
and must not be based purely on judgemental consideration. The [[pra|PRA]] expects firms
...
not incorporated into EAD or CF estimates, then the [[pra|PRA]] expects the firm to be able
...
([[crr|CRR]]) Part and make any adjustments to the downturn EADs or CFs that are required by
Article 181(1)(b)(ii)(2) of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part.

17.10 The [[pra|PRA]] expects that firms directly estimating CFs, in accordance with Article
182(1)(a) of the Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part, should ensure that
...
drawn at observation date in accordance with paragraph 17.8, the [[pra|PRA]] expects that where
...
Based Approach ([[crr|CRR]]) Part for estimates to include a MoC related to estimation
errors;
...
estimate. The [[pra|PRA]] expects firms to consider whether the pattern of distribution in
realised CFs means that some further [[07-segmentation|segmentation]] is needed (eg treating facilities
...
Credit Risk: Internal Ratings Based Approach ([[crr|CRR]]) Part.

17.13 The [[pra|PRA]] has not set an expectation that firms should include the probability of
...
[[pra|PRA]] expects that firms should only make such adjustments if they can be made in a robust
manner.

17.14 The [[pra|PRA]] expects that accrued interest as referred to in paragraph 17.15, other due
payments, and limit excesses should be included in EAD or CF reference data.

17.15 The [[pra|PRA]] expects that estimation of accrued interest should take account of changes in
...
17.16 The [[pra|PRA]] considers that inclusion of post-default interest does not need to be included
in estimates of either EAD or CF, or LGD.

17.17 The [[pra|PRA]] expects that measures of realised EADs or CFs in reference data should not
be capped to the principal amount outstanding or facility limits.

17.18 The [[pra|PRA]] expects that firms directly estimating CFs should exclude exposures at, or in
excess of, limit at observation from the RDS used to model under-limit accounts.

17.19 The [[pra|PRA]] expects that EAD or CF estimates for accounts in excess of their limit should
...
limits provided the conditions in Article 205 of the Credit [[05-risk_mitigation|Risk Mitigation]] ([[crr|CRR]]) Part are met.
The [[pra|PRA]] considers however that as EAD or CF estimates should reflect the amount that
would be outstanding in the event of a default a firm’s estimates should reflect that the firm’s
ability to constrain the drawdown of credit balances in such a scenario will be particularly tested. Moreover, the [[pra|PRA]] expects the appropriate CF estimate to be higher when measured
as a percentage of a net limit than of a gross limit.

17.21 The [[pra|PRA]] considers that the lower the net limit as a percentage of gross limits or
...
borrowers encounter difficulties. The [[pra|PRA]] considers that application of a zero net limit is
...
17.23 The [[pra|PRA]] expects that as EADs or CFs need to be estimated conditional on default by
