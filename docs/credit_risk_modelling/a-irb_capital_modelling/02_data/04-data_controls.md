...
These data controls collectively ensure that all information used for modelling and reporting purposes is fit for purpose and satisfies regulatory expectations for accuracy, completeness, and integrity. Furthermore, the framework provides traceable audit evidence demonstrating compliance with the principles set out by the BCBS, PRA, and PA — including BCBS 239 Principles 3 and 4 (“Accuracy and Completeness”), CRR Article 174 (as adopted by the PRA), and PA Regulation 68(12) of the Banks Act.