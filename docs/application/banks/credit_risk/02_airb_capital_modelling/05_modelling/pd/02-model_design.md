Here’s a structured write-up for your **Model Design** section based on what you’ve provided, keeping it clear, regulatory-aligned, and consistent with your earlier sections:
...
### 1. Risk Differentiation (Risk Diff) Phase

**Objective:** Develop a rating model with strong discriminatory power, enabling robust rank ordering of accounts.

* **Segmentation Analysis:** The portfolio was segmented into groups of accounts sharing common risk drivers and similar default relationships. This segmentation allows for more accurate PiT PD estimation and maximises the model’s overall risk separation.
* **Variable Analysis:**
  ...
  * **Variable transformation** (e.g., binning, log transformations) to improve predictive strength and model stability.
* **Model Estimation:** Logistic regression models were developed for each segment to estimate PiT PDs.

---

### 2. Risk Quantification (Risk Quant) Phase
...
* **LRA PD Calculation:** For each grade, LRA default rates were computed using data spanning a mix of good and bad economic periods, in line with CRR Article 180(1)(a). These LRA PDs represent the *Calibrated PD*.
* **Margin of Conservatism (MoC):** Applied at the grade level to account for estimation uncertainty, data limitations, and potential future changes.
...
* **CRR Articles 174, 179, and 180** – Segmentation, data representativeness, and calibration in line with long-run average default rates.
* **PRA SS4/24 Paragraph 11.20** – Quantitative and qualitative validation tests performed during risk quantification.
* **Basel Requirements** – Incorporation of both rank-ordering capability and appropriate PD level setting.
