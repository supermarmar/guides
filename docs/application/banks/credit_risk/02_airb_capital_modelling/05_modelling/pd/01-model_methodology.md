Here’s a cleaned-up, structured version of your **Model Methodology – PD Rating Philosophy** section that keeps all your details but presents them clearly and regulator-friendly.
...
* **CRR Art. 180(2)(a):** Grade-level PDs must be consistent with observed long-run average (LRA) default rates over a mix of good and bad economic periods.
* **SS4/24 (10.10):** Rating systems can be Point-in-Time (PiT), Through-the-Cycle (TTC), or a blend.
...
* **Rationale:**
  ...
  * Meets CRR Art. 180(2)(a) by incorporating current, relevant risk drivers.
...
Got it 👍 — let’s structure the **EAD Model Methodology** section to mirror the way we wrote the **PD Model Methodology**, but adapted to **Exposure at Default (EAD)**. This way it has a clear regulatory and IFRS9 alignment, while being consistent in style.