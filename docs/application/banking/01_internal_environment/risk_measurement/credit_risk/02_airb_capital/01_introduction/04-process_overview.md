...
High level descriptive statistics such as current total portoflio balance, product [[06-segmentation|segmentation]], target customers and strategy.
...
2. [[03-risk-differentiation|Risk Differentiation]]: Point-in-Time (PiT) models should demonstrate sufficient accuracy, discriminatory power, and stability across development, out-of-sample (OOS), and out-of-time (OOT) datasets.
...
- [[03-risk-differentiation|Risk Differentiation]]: Range of PiT accuracy (measured via relative prediction error), should indicatie strong alignment between actual and predicted outcomes per segment.
