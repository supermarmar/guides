...
| **Accuracy**     | Conformance to source system records; reconciliation to production systems. | Actual distirbution (min, max, etc.) of a data field over a specific time should be validated against its expected distribution.  | BCBS 239 §(36)(c) |
