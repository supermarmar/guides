...
Banks generally follow the IFRS 9 methodology when dealing with impairments, and provisions will be held for eligible exposures. The IFRS 9 ECL calculation has the following components:
