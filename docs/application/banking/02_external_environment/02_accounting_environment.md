...
The [International Accounting Standards Board (IASB)]() is an independent, private-sector body that develops and approves International Financial Reporting Standards (IFRS). It is the standard-setting body of the [[ifrs_foundation|IFRS Foundation]] and is overseen by a group of Trustees. It consists of an international group of experts (14 members) with diverse geographical and professional backgrounds. It researches, develops, and publishes IFRS standards, which are now required in over 140 jurisdictions.

While both the IASB and the [[bis|Bank for International Settlements]] ([[bis|BIS]]) influence global finance, they operate with different structures, goals, and levels of authority. Unlike the [[bis|BIS]], which is a forum for government authorities, the IASB is a private standard-setter. The IASB cannot force any country or company to use its standards. It lacks enforcement power; if a company violates IFRS, it is the national regulator (like the SEC in the U.S. or the [[fca|FCA]] in the UK) that takes action, not the IASB.
