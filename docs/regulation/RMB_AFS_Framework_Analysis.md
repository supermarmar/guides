...
RMB's balance sheet differs structurally from a typical commercial bank in one fundamental way: it is an **investment bank**, not a retail bank. Its balance sheet is therefore predominantly wholesale — assets are corporate loans, structured products, and trading positions, while funding comes from corporate deposits and wholesale markets rather than retail depositors.

### Assets

#### Banking Book

RMB's banking book is composed almost entirely of **wholesale corporate credit**, which is the mirror-image of a typical retail bank's loan portfolio.
...
RMB has a **significantly larger trading book relative to its balance sheet** than a conventional retail or commercial bank. This is driven by its **Global Markets** business, which is one of the largest in South Africa and operates across:
...
Trading book assets are marked to market daily:

- **Level 1:** Exchange-traded derivatives (JSE-listed futures and options), government bonds with active secondary market pricing.
- **Level 2:** OTC interest rate swaps, FX forwards, and credit instruments priced off observable yield curves (JIBAR, SOFR, RSA sovereign curve).
- **Level 3:** Structured products, private credit instruments, and **private equity investments** — where no active market exists and fair value is model-derived. Private equity (a major RMB business line) generates Level 3 valuations and is a key structural difference from a standard bank's trading book.

> **Key difference from framework:** RMB's private equity portfolio (held under Private Equity, a dedicated business line) sits largely as a Level 3 fair value asset. It is not a conventional trading book position but is nonetheless marked to model. The significant gain from the Studio 88 realisation in FY2024 illustrates how lumpy and event-driven this component of income is.

### Liabilities

- **Corporate deposits:** The dominant funding source for RMB's banking book. Unlike a retail bank, there are **no individual retail deposits**. Deposits come from large corporates, institutional investors, and government entities. Core deposits grew **5% in FY2024**, with SA investment deposits growing **19% on average**. Corporate transactional banking (CTB) is a growing source of sticky operational deposits — CTB delivered **PBT growth of 26% in FY2024** partly on the back of deposit momentum.
- **Wholesale funding / Interbank:** RMB draws on Treasury's wholesale funding programme and interbank markets to fund its balance sheet, priced off the JIBAR or repo rate. There is no meaningful retail deposit base to act as a structural funding buffer.
- **Derivatives liabilities:** Offsetting positions from the trading book (fair value liabilities on derivatives).

> **Key difference from framework:** The absence of retail deposits makes RMB's liability structure inherently more reliant on wholesale funding and institutional deposits than the framework implies. This has liquidity risk implications and means the loan-to-deposit ratio metric (a standard stability indicator) is less meaningful in isolation for RMB.

### Equity

RMB is **not a separately listed entity** — it is a segment of FirstRand Bank Limited. For segment reporting purposes, FirstRand allocates capital to RMB based on its risk-weighted assets.

- **Allocated equity / capital:** Reflects the segment's share of FirstRand Bank's total equity.
- **Retained earnings:** Attributable to the segment on a normalised basis; earnings are retained within FirstRand and redistributed via the group's capital allocation framework.
- There is no separate share capital or share premium specific to RMB as a segment.
...
- **Cost of funding:** Tied to JIBAR/repo rate; RMB's CTB business generates lower-cost operational deposits which improve the funding spread.

### Non-Interest Revenue (NIR)

NIR is **disproportionately important** for RMB relative to the generic bank framework. **NIR grew 12% in FY2024**, driven by Global Markets recovery, private equity realisations, and investment banking fees. NIR broadly maps to the framework's two sub-categories, but with a very different character:

#### Non-interest Income (Banking Book)

- **Investment banking fees:** Advisory fees (M&A, restructuring), debt capital markets (DCM), equity capital markets (ECM), and structured finance arrangement fees. **Knowledge-based fees grew 55% in FY2024**, reflecting strong deal origination. These are one-off, deal-driven fees — inherently lumpy compared to account or transaction fees at a retail bank.
- **Commitment fees:** On undrawn corporate facilities.
- **Corporate transactional banking fees:** Account management fees, payment processing fees, and custody fees from the CTB business. This is the closest RMB gets to the "account fees, transaction fees" described in the framework — but serving corporates rather than individuals.
- **Private equity income:** Annuity income (dividends, management fees) from investee companies plus realisation gains on exits (e.g. Studio 88 in FY2024). This does not appear in the standard framework at all, and is unique to investment banks with a principal investing mandate.

> **Key difference from framework:** The framework references standard retail banking fees (account fees, insurance fees). RMB generates no insurance income and no individual account fees. Instead, it earns advisory, deal origination, and PE-related income — far more cyclical and episodic.

#### Trading Income (Trading Book)

Trading income from Global Markets (FICC and equity derivatives) is marked to market daily. **Global Markets was a primary driver of NIR recovery in FY2024** after a weaker prior year, consistent with the framework's description of daily M2M gains/losses feeding into the P&L.
...
RMB's cost structure differs from a retail bank in composition, even if the framework's categories still apply:
...
Fixed, semi-fixed, and variable cost categories apply, but the **variable component is proportionally larger** at RMB due to performance-linked bonuses — costs are more tied to revenue generation than at a retail bank.
...
Consistent with the framework: RMB's income is subject to South African corporation tax at **28%** (as noted in the framework for South Africa). FirstRand applies a normalised effective tax rate; deferred tax movements relating to private equity realisations and structured products are relevant.

### Profit & Loss (P&L)

Following the framework's formula:
...
| **= Normalised Earnings** | **R9,744m** for FY2024 (26% of FirstRand group) |
| **EPS equivalent** | Captured at FirstRand group level, not separately for RMB |

> **Key difference from framework:** RMB is not separately listed, so there is no standalone EPS. "Earnings" flows upward into FirstRand's consolidated result. The framework's reference to preference shareholder dividends and standalone EPS does not apply to RMB as a segment.
...
**Normalised earnings of R9,744m in FY2024** represented a meaningful increase. Growth is measured at FirstRand group level where RMB contributes ~26% of group earnings. EPS growth is tracked at the FirstRand parent level.
...
RMB's **ROE was approximately 20.3% in FY2024** (declining from ~21.1% in FY2023), and trended further to ~18.3% in H1 FY2025 as Global Markets' contribution to RWA utilisation moderated.

This ROE is **higher than a typical retail bank** and reflects the fee-intensive, lower-capital-intensity model of investment banking. However, because RMB is capital-intensive in its trading book and private equity portfolio, it requires careful RWA management.
...
The framework's **loan-to-deposit ratio** is a less clean metric for RMB because:
- Deposits are entirely corporate/institutional — more mobile and rate-sensitive than retail deposits.
- RMB relies more heavily on wholesale funding than a retail bank.
- CTB's growing deposit base is improving this picture, but RMB has no structural advantage equivalent to a large retail deposit franchise.

Core deposits grew only **5% in FY2024** versus advances growth of **11%**, indicating a widening loan-to-deposit gap — a structural consideration for funding stability.

### Capital Strength (BS)

RMB does not report standalone capital ratios (CET1/RWA) — this is managed at the FirstRand Bank level. Capital is allocated to RMB based on its risk profile. The framework's caution about comparing CET1 ratios across institutions applies here in a different way: RMB's capital intensity is driven by trading book RWAs and private equity RWAs, which behave differently from retail credit RWAs.
...
## Summary: How RMB Fits the Framework — and Where It Diverges

| Framework Element | RMB Fit | Key Difference |
|---|---|---|
| Banking book (loans) | ✅ Present | Wholesale/corporate only; no retail products |
| HQLAs | ✅ Present | Smaller relative to assets |
...
| Capital ratios (CET1) | ⚠️ Consolidated | Managed at FirstRand Bank level, not segment |
| ROE | ✅ Present | ~20% in FY2024, higher than retail peers, driven by fee model |

---

*Sources: FirstRand Analysis of Financial Results FY2024 (year ended 30 June 2024); FirstRand H1 FY2025 Results (six months ended 31 December 2024); RMB Annual Results press releases (rmb.co.za); RMB LinkedIn Financial Results 2024.*
